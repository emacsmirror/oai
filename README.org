...
** How images sent?
In ~oai-block-tags-replace~ we replace links and tags that detecs as “image” by ~oai-block-tags--filepath-to-language~ with “@image:/path@” strings. And then split message to vector by such strings. All other code aware that :content of “messages” may be a vector.
* Other packages
